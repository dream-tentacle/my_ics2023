...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)         \
  ...
  INSTPAT("??????? ????? ????? 111 ????? 00100 11", andi, I,
          R(rd) = src1 & imm);
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli, R,
          panic("slli not implemented"));
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli, R,
          panic("srli not implemented"));
