...
// #include <assert.h>
// #include <math.h>
// static uint64_t randseed = 111;
// int rand() {
//   randseed = randseed * 1103515245 + 12345;
//   return randseed & 0x7fff;
// }
// double p(fixedpt x) { return (double)(x) / (1 << 8); }
...
//     A = fixedpt_rconst(a);
//     B = fixedpt_rconst(b);
//     cmp(a * b, (fixedpt_mul(A, B)));
//     cmp(a / b, (fixedpt_div(A, B)));
//     // cmp(floor(a), fixedpt_floor(A));
//     // cmp(floor(b), fixedpt_floor(B));
//     // cmp(ceil(a), fixedpt_ceil(A));
//     // cmp(ceil(b), fixedpt_ceil(B));
//   }
//   printf("PASS\n");
//   return 0;
// }
